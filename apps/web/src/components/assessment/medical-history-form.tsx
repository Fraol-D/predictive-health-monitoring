  ...
  return (
    <div className="h-[60vh] max-h-[700px] overflow-y-auto pr-4 sidebar-scroll-container">
      <div className="space-y-6">
        <div>
          <h3 className="text-lg font-medium mb-4 text-foreground">Family History</h3>
            ...
            {Object.entries(data.familyHistory).map(([condition, value]) => {
              ...
              return (
                <label key={condition} className="flex items-center space-x-3">
                  ...
                  />
                  <span className="text-sm text-foreground capitalize">{condition.replace(/([A-Z])/g, ' $1').trim()}</span>
                </label>
              );
            })}
          </div>
        ...
        <div>
          <h3 className="text-lg font-medium mb-4 text-foreground">Existing Conditions</h3>
          <div className="space-y-2">
            {[
              'hypertension',
              'diabetes',
              ...
              <label key={condition} className="flex items-center space-x-3">
                <input
                  ...
                  className="rounded h-5 w-5 border-border text-primary focus:ring-primary/50"
                />
                <span className="text-sm capitalize text-foreground">{condition}</span>
              </label>
            ))}
          </div>
        </div>
        ...
        <div>
          <h3 className="text-lg font-medium mb-4 text-foreground">Current Medications</h3>
          <div className="space-y-2">
            {[
              ...
              <label key={medication} className="flex items-center space-x-3">
                <input
                  ...
                  className="rounded h-5 w-5 border-border text-primary focus:ring-primary/50"
                />
                <span className="text-sm capitalize text-foreground">{medication}</span>
              </label>
            ))}
          </div>
        </div>
        ...
        <div>
          <h3 className="text-lg font-medium mb-4 text-foreground">Allergies</h3>
          <div className="space-y-2">
            {[
              'penicillin',
              'sulfa drugs',
              ...
              <label key={allergy} className="flex items-center space-x-3">
                <input
                  ...
                  className="rounded h-5 w-5 border-border text-primary focus:ring-primary/50"
                />
                <span className="text-sm capitalize text-foreground">{allergy}</span>
              </label>
            ))}
          </div>
        </div>
